...
export const Contact = () => (
  <div>
    ...
    <div className="contact-items">
      ...
      <span className="mini-panel">LinkedIn: <a href="https://www.linkedin.com/profile/view?id=278124861">Link</a> </span>
    ...
    <a href="http://stackoverflow.com/users/1846995/maciej-baranowski">
      <img src="http://stackoverflow.com/users/flair/1846995.png?theme=clean" width="208" height="58"/>
    </a></span>
    </div>
  </div>
);
